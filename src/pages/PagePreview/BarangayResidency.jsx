...
export default function BarangayResidency({setActiveStep,formdata}){
...
<br/>
        ...
        >
            ...
            Filipino/na,{formdata.brgyform.age} of legal age, and residing with postal address at
            </Typography>
        </Stack>
    ...
    <br/>
        ...
        >
            ...
            > 
         This <b> CERTIFICATION</b> is issued this _____ day of ________________ in the Year of our Lord Two Thousand and Twenty - two at the Council of Barangay. Talon Uno, Las Piñas City upon the request of above named person, attesting among others of his/her present residency is at the above given address and is WITHIN this barangay for ___________________________________ and for  whatever any legal purposes it may deem to use in the premises. 
            </Typography>     
        </Stack>
    <br/>
    <br/>
    <Stack
        ...
        >
            ...
            > 
            Voter’s Precinct No. {formdata.brgyform.precintno}
            </Typography>  
