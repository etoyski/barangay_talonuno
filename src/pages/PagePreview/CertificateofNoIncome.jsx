...
export default function CertificateofNoIncome({setActiveStep,formdata}){
...
<br/>
    ...
    <br/>
        ...
        <Typography
            ...
            > 
Record submitted to this Office declares among others that he/she has NO KNOWN SOURCE since he/she was separated from his/her last employment last _____________________ up to this writing.            </Typography>    
