...
export default function CertificateofIndigency({setActiveStep,formdata}){
...
<br/>
        ...
        <Typography
            ...
            > 
           Brgy.Talon Uno, Las Piñas City, actual inspection conducted show positive result that he/she belongs to one of many indigent family which income are lower and far from average daily income rate in the Philippines.
            </Typography>    
        </Stack>
    <br/>
        <Stack
        ...
        <Typography
            ...
            > 
         He /She was given a privilege to exercise his/her civil rights as one of among indigent resident of this barangay to be a principal beneficiary of any legal programs launched by national authorities and local government agencies 
            </Typography>    
    ...
    <Stack
        ...
        >
            ...
            > 
         Voter’s Precinct No. <u> {formdata.brgyform.precintno}</u>
            </Typography>  
        </Stack>
        </Box>
        <Stack
