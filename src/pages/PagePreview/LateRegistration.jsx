...
export default function LateRegistration({setActiveStep,formdata}){
...
<br/>
        ...
        was allegedly born on ________________________ at _________________________  is the son/daughter of _______________________________ and ________________________________ which presently residing at 
            </Typography>
        </Stack>
        ...
        <Typography
            ...
            > 
Barangay Talon Uno, Las Piñas City.            </Typography>    
        </Stack>
    <br/>
        <Stack
        direction="row"
        ...
        <Typography
            ...
            > 
That due to unavoidable circumstances, said child was not registered after birth at the Civil Registry Office of this _________________________________ and was only this time that the above-named child was to be registered.            </Typography>    
        ...
        >
            ...
            > 
This CERTIFICATION is issued this _______ day of __________________in the Year of Our Lord Two Thousand and Twenty-two at the Council of Barangay Talon Uno, Las Piñas City, attesting among others of the birth of the above named child for the LATE REGISTRATION of ______________________________________________ and for whatever legal purposes it may deem to use in the premises.            </Typography>     
        </Stack>
    <br/>
